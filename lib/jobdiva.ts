...
export class JobDivaService {
  ...
  async fetchInitialData() {
    ...
    return this.makeRequest(`/apiv2/bi/NewUpdatedSubmittalInterviewHireActivityRecords?fromDate=${fromDate}&toDate=${toDate}&userFieldsName=L1 Interview Status,L2 Interview Status,L1 attended`, 'GET');
  }
